...
namespace MerkaCentro.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260205012701_AddAdvancedAndPolishTables")]
    partial class AddAdvancedAndPolishTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MerkaCentro.Domain.Entities.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MerkaCentro.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MerkaCentro.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MerkaCentro.Domain.Entities.SyncQueueItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MerkaCentro.Domain.Entities.Alert", b =>
                {
                    b.HasOne("MerkaCentro.Domain.Entities.User", "AcknowledgedByUser")
                        .WithMany()
